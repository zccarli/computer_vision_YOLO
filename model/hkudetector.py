...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, args):
        ...
        self.det_head = self._make_detection_head(in_channels=512*block.expansion, out_channels=15)
        ...
        # self.det_head = self._make_detection_head(in_channels=2048, out_channels=256)
        ##################################################################
